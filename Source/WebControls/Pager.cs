...
namespace Cb.WebControls
{
    ...
    public class Pager : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        {
            string templateCell = "<a title=\"" + BackToFirstClause + "\" class=\"nextprev\" href=\"{0}\">" + FirstClause + "</a>";
        ...
        {
            string templateCell = "<a title=\"" + BackToPageClause + " " + (CurrentIndex - 1).ToString() + "\" class=\"nextprev\" href=\"{0}\">" + PreviousClause + "</a>";
        ...
        {
            string templateCell = "<a title=\"" + NextToPageClause + " " + (CurrentIndex + 1).ToString() + "\" class=\"nextprev\" href=\"{0}\">" + NextClause + "</a>";
            return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, (CurrentIndex + 1).ToString()));
        }
        ...
        {
            //string templateCell = "<a title=\"" + PageClause.ToString() + " " + pageNumber.ToString() + "\" href=\"{0}\">" + pageNumber.ToString() + "</a>";
            string templateCell = "<a class=\"nocurrent\"  title=\"" + PageClause.ToString() + " " + pageNumber.ToString() + "\" href=\"{0}\">" + pageNumber.ToString() + "</a>";
        ...
        {
            string templateCell = "<select class=\"goto\" name=\"ddlTes\" id=\"ddlTes\" onchange=\"javascript:handleGoto(this);\">{0}</select>";
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if ((int)ItemCount <= PageSize) return;
