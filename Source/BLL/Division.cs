...
namespace Cb.BLL
{
    ...
    {
        private static IGeneric2C<PNK_Division, PNK_DivisionDesc> dal_2C;

        private string prefixParam;

        public DivisionBLL()
        {
            Type t = typeof(Cb.SQLServerDAL.Generic2C<PNK_Division, PNK_DivisionDesc>);
            dal_2C = DataAccessGeneric2C<PNK_Division, PNK_DivisionDesc>.CreateSession(t.FullName);
        ...
        public IList<PNK_Division> GetList(int langId, string name, string Id, string newsCateId, int pageIndex, int pageSize, out int total)
        {
            IList<PNK_Division> lst = new List<PNK_Division>();
            ...
            lst = dal_2C.GetList("Division_Get", param, out total);
            return lst;
        }
    }
}
