<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Picture_Video.ascx.cs" Inherits="Cb.Web.Pages.GalleryManagement.Picture_Video" %>
                                                    ...
                                                    <div class="esg-media-cover-wrapper">
                                                        ...
                                                        <div class="esg-entry-cover esg-fade" data-delay="0">
                                                            ...
                                                            <div class="esg-center eg-post-5874 eg-w_jason-element-32-a esg-slide" data-delay="0.1">
                                                                <a class="eg-w_jason-element-32 eg-post-5874 esgbox" runat="server" id="hypImg"
