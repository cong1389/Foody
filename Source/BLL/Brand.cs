...
namespace Cb.BLL
{
    ...
    {
        private static IGeneric2C<PNK_Brand, PNK_BrandDesc> dal_2C;

        private string prefixParam;

        public BrandBLL()
        {
            Type t = typeof(Cb.SQLServerDAL.Generic2C<PNK_Brand, PNK_BrandDesc>);
            dal_2C = DataAccessGeneric2C<PNK_Brand, PNK_BrandDesc>.CreateSession(t.FullName);
        ...
        public IList<PNK_Brand> GetList(int langId, string name, string Id, string newsCateId, int pageIndex, int pageSize, out int total)
        {
            IList<PNK_Brand> lst = new List<PNK_Brand>();
            ...
            lst = dal_2C.GetList("Brand_Get", param, out total);
            return lst;
        }
    }
}
