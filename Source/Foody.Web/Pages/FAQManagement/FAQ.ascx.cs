...
namespace Cb.Web.Pages.FAQManagement
{
    public partial class Faq : DGCUserControl
    {
        #region Parameter
        ...
        protected void rptResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //HtmlControl divBox = e.Item.FindControl("divBox") as HtmlControl;
                //divBox.
                ...
                ltrDetail.Text = data.ProductDesc.Detail;
            }
        }
