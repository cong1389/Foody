...
namespace Cb.BLL.GenControl
{
    [Serializable]
    public class GenControlBLL
    {
        private static IGeneric2C<PNK_GenControl, PNK_GenControlDesc> dal_2C;

        private string prefixParam;

        public GenControlBLL()
        {
            Type t = typeof(Cb.SQLServerDAL.Generic2C<PNK_GenControl, PNK_GenControlDesc>);
            dal_2C = DataAccessGeneric2C<PNK_GenControl, PNK_GenControlDesc>.CreateSession(t.FullName);
        ...
        /// <returns></returns>
        public IList<PNK_GenControl> GetList(int langId, string name, int pageIndex, int pageSize, out int total)
        {
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public IList<PNK_GenControl> GetList(int langId, string name, string publish, int parentId, bool isTree, int pageIndex, int pageSize, out int total)
        {
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public IList<PNK_GenControl> GetList(int langId, string name, string publish, int parentId, bool isTree, string field, int pageIndex, int pageSize, out int total)
        {
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public IList<PNK_GenControl> GetList(int langId, string name, string publish, string id, int parentId, bool isTree, string field, int pageIndex, int pageSize, out int total)
        {
            return GetList(langId, name, publish, id, parentId, int.MinValue, isTree, field, pageIndex, pageSize, out  total);
        }

        public IList<PNK_GenControl> GetList(int langId, string name, string publish, string id, int parentId, int uncludeMe, bool isTree, string field, int pageIndex, int pageSize, out int total)
        {
            IList<PNK_GenControl> lst = new List<PNK_GenControl>();
            ...
            string key = string.Format("GenControl_GetList_{0}_{1}", WebUtils.CurrentUserIP, string.Join("_", keyArr));
            total = 0;

            //Get cache
            //if (!CacheHelper.Get(key, out lst))
            //{
                lst = dal_2C.GetList("GenControl_Get", param, out total);
        ...
        public IList<PNK_GenControl> GetAllChild(int categoryId, bool includeMe)
        {
            int total;
            ...
            //if (!CacheHelper.Get(key, out lst))
            //{
            lst = dal_2C.GetList("GenControl_GetChild", param, out total);
            //CacheHelper.Add(lst, key);
            //}
            //else
            //{
        ...
        public IList<PNK_GenControl> GetListTree(int langId, string name, int pageIndex, int pageSize, out int total)
        {
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public IList<PNK_GenControl> GetListTree(int langId, string name, string publish, int id, int parentId, string treeNameUrl
            , int uncludeMe, bool isTree, string field, int pageIndex, int pageSize, out int total)
        {
            ...
            string[] keyArr = param.Select(x => x.Value.ToString()).ToArray();
            string key = string.Format("GenControl_GetListTree_{0}_{1}", WebUtils.CurrentUserIP, string.Join("_", keyArr));
            total = 0;

            //Get cache
            if (!CacheHelper.Get(key, out lst))
            {
                lst = dal_2C.GetList("GenControl_Tree_Get", param, out total);
                CacheHelper.Add(lst, key);
            }
            else
            {
