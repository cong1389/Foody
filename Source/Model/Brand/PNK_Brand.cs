...
namespace Cb.Model.Brand
{
    public class PNK_Brand
    {
        #region fields
        private int id;
        ...
        private string code;
        private PNK_BrandDesc contentstaticDesc;

        #endregion

        #region properties

        public PNK_BrandDesc BrandDesc
        {
        ...
        public PNK_Brand()
        {
            ...
            contentstaticDesc = new PNK_BrandDesc();
        }
        public PNK_Brand(int id,
                    int categoryId,
                    string image,
                    string resource,
                    string published,
