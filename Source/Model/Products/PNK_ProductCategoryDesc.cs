...
namespace Cb.Model.Products
{
    public class PNK_ProductCategoryDesc
    {
        ...
        private string treeNameUrlUniCodeDesc;
        ...
        public string TreeNameUrlUnicodeDesc
        {
            get { return this.treeNameUrlUniCodeDesc; }
            set { this.treeNameUrlUniCodeDesc = value; }
        }
                    ...
                    string treeIdDesc)
        {
            ...
            this.treeNameUrlUniCodeDesc = treeNameUrlUniCodeDesc;
