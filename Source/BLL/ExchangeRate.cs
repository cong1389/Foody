...
namespace Cb.BLL
{
    ...
    {
        private static IGeneric2C<PNK_ExchangeRate, PNK_ExchangeRateDesc> dal_2C;

        private string prefixParam;

        public ExchangeRateBLL()
        {
            Type t = typeof(Cb.SQLServerDAL.Generic2C<PNK_ExchangeRate, PNK_ExchangeRateDesc>);
            dal_2C = DataAccessGeneric2C<PNK_ExchangeRate, PNK_ExchangeRateDesc>.CreateSession(t.FullName);
        ...
        public IList<PNK_ExchangeRate> GetList(int langId, string name, string Id, string newsCateId, int pageIndex, int pageSize, out int total)
        {
            IList<PNK_ExchangeRate> lst = new List<PNK_ExchangeRate>();
            ...
            lst = dal_2C.GetList("ExchangeRate_Get", param, out total);
            return lst;
        }
    }
}
