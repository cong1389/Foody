<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="admin_editexchangerate.ascx.cs"
    Inherits="Cb.Web.Admin.Pages.ExchangeRate.admin_editexchangerate" %>
                ...
                <div class="form-horizontal">
                    <div class="panel-body">
                        ...
                        <div class="form-group hidden">
                            ...
                            <label class="col-sm-2 control-label">
                                <asp:Literal ID="Literal6" runat="server" Text="Mã Code"></asp:Literal>
                            </label>
                            <div class="col-sm-4">
                                <input id="txtCode" runat="server" type="text" value="33" name="txtCode" class="form-control" />
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="adnGeneral" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal1" runat="server" Text="USD"></asp:Literal></label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="txtName" id="txtAmountUSD" runat="server" class="form-control form-group" value="1" disabled/>
                                                        </div>

                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal2" runat="server" Text="Từ loại ngoại tệ"></asp:Literal></label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="txtName" id="txtFromCurrency" runat="server" value="USD" disabled class="form-control form-group" />
                                                        </div>
                                                     ...
                                                     <div class="form-group">
                                                        <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal4" runat="server" Text="VNĐ"></asp:Literal></label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="txtName" id="txtAmount" runat="server" class="form-control form-group" />
                                                        </div>

                                                         <label class="col-sm-2 control-label">
                                                            <asp:Literal ID="Literal3" runat="server" Text="Đến loại ngoại tệ"></asp:Literal></label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="txtName" id="txtToCurrency" runat="server" value="VNĐ" disabled class="form-control form-group" />
                                                        </div>
                                                    </div>
