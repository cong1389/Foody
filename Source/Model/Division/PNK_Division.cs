...
namespace Cb.Model.Division
{
    public class PNK_Division
    {
        #region fields
        private int id;
        ...
        private string code;
        private PNK_DivisionDesc contentstaticDesc;

        #endregion

        #region properties

        public PNK_DivisionDesc DivisionDesc
        {
        ...
        public PNK_Division()
        {
            ...
            contentstaticDesc = new PNK_DivisionDesc();
        }
        public PNK_Division(int id,
                    int categoryId,
                    string image,
                    string resource,
                    string published,
