...
{
    public partial class block_request : DGCUserControl
    {
        #region Parameter
        ...
        private void InitPage()
        {
            ...
            ltrRequireCus.Text = LocalizationUtility.GetText(ltrRequireCus.ID, Ci);
        ...
        private void GetWebsiteHot()
        {
            ...
            if (total > 0)
            {
                ltrRequireCus.Text = lst[0].ContentStaticDesc.Detail;
            }
        }
