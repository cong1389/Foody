...
{
    [Serializable]
    public class ProgramTourBLL
    {
        private static IGeneric2C<PNK_ProgramTour, PNK_ProgramTourDesc> dal_2C;

        private string prefixParam;

        public ProgramTourBLL()
        {
            Type t = typeof(Cb.SQLServerDAL.Generic2C<PNK_ProgramTour, PNK_ProgramTourDesc>);
            dal_2C = DataAccessGeneric2C<PNK_ProgramTour, PNK_ProgramTourDesc>.CreateSession(t.FullName);
        ...
        public IList<PNK_ProgramTour> GetList(int langId, string name, string Id, string newsCateId, int pageIndex, int pageSize, out int total)
        {
            IList<PNK_ProgramTour> lst = new List<PNK_ProgramTour>();
            ...
            lst = dal_2C.GetList("ProgramTour_Get", param, out total);
            return lst;
        }
    }
}
