...
namespace Cb.Model
{
    public class PNK_Attribute
    {
        ...
        private PNK_AttributeDesc attributeDesc;
        public PNK_AttributeDesc AttributeDesc
        {
            get { return attributeDesc; }
            set { attributeDesc = value; }
        }

        public PNK_Attribute()
        {
            ...
            this.attributeDesc = new PNK_AttributeDesc();
